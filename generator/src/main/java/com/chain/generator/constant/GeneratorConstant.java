...
package com.chain.generator.constant;
...
public interface GeneratorConstant {
     ...
     * 分页排序参数父类全称，带包名
     */
    //String SUPER_PAGE_ORDER_PARAM_CLASS = "com.stnts.framework.core.pagination.BasePageOrderParam";
    /**
     * 公共id参数类全称，带包名
     */
    //String ID_PARAM_CLASS = "com.stnts.framework.common.param.IdParam";
    /**
     * 分页对象类全称，带包名
     */
     ...
     * 分页信息类全称，带包名
     */
    //String PAGE_INFO_CLASS = "com.stnts.framework.core.pagination.PageInfo";
    /**
     * 公共结果类全称，带包名
     */
    String API_RESULT_CLASS = "com.chain.common.ResultEntity";
    /**
     * 分组验证Add.class类路径
     */
    String VALIDATOR_ADD_PACKAGE = "com.chain.validator.groups.Add";
    /**
     * 分组验证Update.class类路径
     */
    String VALIDATOR_UPDATE_PACKAGE = "com.chain.validator.groups.Update";
}
